...
namespace dstar_global_planner{
  ...
  class DStarPlannerROS : public nav_core::BaseGlobalPlanner{
    ...
    public:
       ...
       * @param tf2 A pointer to a transform listener
  ...
  protected:
    ...
    private:
      ...
      std::string tf2_prefix_;
      int smooth_size_;

      void mapToWorld(double mx, double my, double& wx, double& wy);

      void clearRobotCell(const tf2::Stamped<geometry_msgs::Pose>& global_pose, unsigned int mx, unsigned int my);
